...
namespace ImGui
{
	...
	inline bool InputFloat2(const char* label, Float2& value)
	{
		static thread_local float v[2];
		...
		bool ret = ImGui::InputFloat2(label, v);
	...
	inline bool InputFloat3(const char* label, Float3& value)
	{
		static thread_local float v[3];
		...
		bool ret = ImGui::InputFloat3(label, v);
	...
	inline bool InputFloat4(const char* label, Float4& value)
	{
		static thread_local float v[4];
		...
		bool ret = ImGui::InputFloat4(label, v);
